(function() {
    ...
    var objectInjectors = ['$rootScope', '$state', '$window', '$log'];
    var fatoryInjectors = ['PublicApisFactory','SwitchFormModeFactory'];
    Controller.$injector = [].concat(objectInjectors, fatoryInjectors);

    function Controller($rootScope, $state, $window, $log, PublicApisFactory, SwitchFormModeFactory){
        var self = this;
        ...
        function init() {
            ...
            $log.log("Initially, I am in form.viewing state");
            /*
            self.inputFields = [
        ...
        function registerEventHandlers() {
            ...
            function changeForm(event, toState, toParams, fromState, fromParams){
                ...
                $log.log("I am in %s state", toState.name);
            }
        }
    }
})();
